     ...
     <section className='px-5 lg:px-0'>
        ...
        <div className=" pt-[5px]">
                    ...
                    <div className="lg:w-[60%] w-full flex flex-wrap justify-between">
                        ...
                        <input type='text' required placeholder='First Name' className='font-dmsans text-[14px] font-normal text-[#767676] outline-none w-full h-[20px]' />

                        </div>
                        <div className="w-[48%] border-b-[1px] border-[#F0F0F0] mt-5">
                        <h3 className='font-dmsans text-[16px] leading-[23px] font-bold text-[#262626]' placeholder='Last Name'>Last Name</h3>
                        ...
                        <div className="w-[48%] border-b-[1px] border-[#F0F0F0] mt-5">
                        <h3 className='font-dmsans text-[16px] leading-[23px] font-bold text-[#262626]' placeholder='Email address'>Email address </h3>

                        <input onChange={handleEmail} type='text' required placeholder='Company@domain.com' className='font-dmsans text-[14px] font-normal text-[#767676] outline-none w-full h-[20px]' />
                        
                        </div>
                        <div className="w-[48%] border-b-[1px] border-[#F0F0F0] mt-5">
                        <h3 className='font-dmsans text-[16px] leading-[23px] font-bold text-[#262626]'>Telephone</h3>

                        <input type='text' required placeholder='Your phone number' className='font-dmsans text-[14px] font-normal text-[#767676] outline-none w-full h-[20px]' />
                    ...
                    <div className="mt-[50px] pb-[50px] border-b-[1px]  border-[#F0F0F0]">
                       ...
                       <input type='text' required placeholder='05228' className='font-dmsans text-[14px] font-normal text-[#767676] outline-none w-full h-[20px]' />
                       </div>
                       <div className="w-[48%] border-b-[1px] border-[#F0F0F0] mt-5">
                       <h3 className='font-dmsans text-[16px] leading-[23px] font-bold text-[#262626]' placeholder='First Name'>Division</h3>
                       <input type='text' required placeholder='Please select' className='font-dmsans text-[14px] font-normal text-[#767676] outline-none w-full h-[20px]' />
                       </div>
                       <div className="w-[48%] border-b-[1px] border-[#F0F0F0] mt-5">
                    ...
                    <div className="mt-[50px] pb-[50px] border-b-[1px]  border-[#F0F0F0]">
                       ...
                       <h3 className='font-dmsans text-[16px] leading-[23px] font-bold text-[#262626]' placeholder='First Name'>Password</h3>
                       ...
                       <input type='text' required placeholder='Repeat password' className='font-dmsans text-[14px] font-normal text-[#767676] outline-none w-full h-[20px]' />
                       </div>
                        </div>
                        </form>
                    ...
                    <div className="">
                        ...
                        <div className=" flex mt-[40px]">                         <input type="checkbox" /> 
                        <p className='font-dmsans text-[14px] font-normal text-[#767676] ms-3'>I have read and agree to the Privacy Policy</p>
                            </div>
                        </div>
                    ...
                    <div className="mt-5">
                    <button onClick={handleSubmit} className='font-dmsans text-[14px] font-bold text-white py-[16px] px-[77px] bg-[#262626]'>Log in</button>
                    </div>
