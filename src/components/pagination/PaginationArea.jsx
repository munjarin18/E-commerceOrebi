...
const PaginationArea = ({pageNumber,paginate,currentPage,next,prev}) => {
  return (
    <>
  <nav className='py-4 mt-[50px] text-center lg:text-end' aria-label="Page navigation example">
    <ul className="inline-flex -space-x-px text-sm">
      ...
      {pageNumber.length > 0 &&
         <li>
         <a onClick={next} className="flex items-center justify-centerz px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
         >
           Next
         </a>
       </li>
