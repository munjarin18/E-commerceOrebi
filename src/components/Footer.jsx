...
const Footer = () => {
  return (
    <footer className='py-[50px] bg-[#F5F5F3] px-2'>
    <Container>
      <Flex className=" flex-wrap">
            ...
            <div className="lg:w-[30%] w-[40%] mt-5 lg:mt-0">
            ...
            <div className="lg:w-[25%]  w-[60%] flex justify-end lg:justify-start items-center lg:items-start">
              <div className="">
